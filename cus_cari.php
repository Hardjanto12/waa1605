...
if (is_null($p)){
  $_GET["p"] = 1;
echo "<meta http-equiv='refresh' content='0; url=cus_cari.php?p=1'>";
}
...
if(isset($_POST['btnCari'])) {
	...
	$pencarianSQL	= "and sub='$txtKataKunci' OR name LIKE '%$txtKataKunci%' ".$pencarianSQL;
}
...
<body>
    <div class="container-fluid">
        <h1 class="display-5">PENCARIAN SUB CUSTOMER</h1>
    </div>
    <div class="container-fluid">
        <!-- search box -->
        <div class="row">
...
$myQry = sqlsrv_query($koneksidb, $datapagecus);
// $nomor  = 0; 
