...
<title>Data Pemakaian Bahan</title></head>
...
<table id="dataTable" class="table-list" width="946" border="0" cellspacing="2" cellpadding="3">
  <tr>
    ...
    <td width="124" bgcolor="#CCCCCC"><div align="left"><strong>Aprv. Date</strong></div></td>
    <td width="73" bgcolor="#CCCCCC"><div align="left"><strong>User Appr.</strong></div></td>
...
?>
  <tr>
    ...
    <td> <?php echo $myData['chtime2']; ?>  </td>
    <td> <?php echo $myData['chuser2']; ?>  </td>
    <td> <?php echo $myData['stts']; ?>  </td>
        <td width="24" align="center"><a href="?open=Pemakaian-Edit&Kode=<?php echo $Kode; ?>&Tanda=<?php echo "1"; ?>" target="_self" 
			onclick="return confirm('YAKIN INGIN MENGUBAH DATA BAGIAN INI ... ?')">Edit</a></td>
        <td width="39" align="center"><a href="?open=Pemakaian-Delete&Kode=<?php echo $Kode; ?>" target="_self" 
			onclick="return confirm('YAKIN INGIN MENGHAPUS DATA BAGIAN INI ... ?')">Delete</a></td>
    <td width="41"><a href="pbh_cetak.php?Kode=<?php echo $Kode; ?>" target="_blank">Cetak</a></td>
  </tr>
