...
if (is_null($p)){
  $_GET["p"] = 1;
echo "<meta http-equiv='refresh' content='0; url=dep_cari.php?p=1'>";
}
...
if(isset($_POST['btnCari'])) {
	...
	$pencarianSQL	= "WHERE dep='$txtKataKunci' OR name LIKE '%$txtKataKunci%' ".$pencarianSQL;
}
...
$stmt = sqlsrv_query( $koneksidb, "SELECT * FROM sub $pencarianSQL" , $params, $options );
...
<body>
    <div class="container-fluid">
        <h1 class="display-5">PENCARIAN KATEGORI</h1>
    </div>
    <div class="container-fluid">
        <!-- search box -->
        <div class="row">
...
$myQry = sqlsrv_query($koneksidb, $datapagedep);
// $nomor  = 0; 
