...
$infoSql= "SELECT * FROM msn $filterSQL";
...
<table class="table-common" width="910" border="0" cellspacing="2" cellpadding="3">
  ...
  <tr>
    <td colspan="2" align="right"><a href="?open=Mesin-Add" target="_self"><img src="images/btn_add_data.png" width="140" height="34" border="0"></a></td>
  </tr>
  <tr>
...
$mySql 	= "SELECT * FROM msn $filterSQL ORDER BY msn ASC ";
...
?>	
      ...
      <tr>
        ...
        <td width="9%" align="center"><a href="?open=Mesin-Delete&Kode=<?php echo $Kode; ?>" target="_self" 
			onclick="return confirm('YAKIN INGIN MENGHAPUS DATA BAGIAN INI ... ?')">Delete</a></td>
        <td width="12%" align="center"><a href="?open=Mesin-Edit&Kode=<?php echo $Kode; ?>" target="_self">Edit</a></td>
      </tr>
...
<?php } ?> 
  ...
  <tr>
	...
	<?php
	for ($h = 1; $h <= $maks; $h++) {
		echo " <a href='?open=Mesin-Data&hal=$h'>$h</a> ";
	}
	?> 
