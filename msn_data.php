...
if (is_null($p)){
  $_GET["p"] = 1;
echo "<meta http-equiv='refresh' content='0; url=?open=Mesin-Data&p=1''>";
}
    ...
    <div class="container">
        ...
        <div class="row mt-3d-flex align-items-center">
            ...
            <div class="col-auto mb-3">
                <a href="?open=Mesin-Add" target="_self">
...
?>
            <tr>
                ...
                <td width="20%">
                    <a href="?open=Mesin-Delete&Kode=<?php echo $Kode; ?>" target="_self"
                        onclick="return confirm('YAKIN INGIN MENGHAPUS DATA BAGIAN INI ... ?')"><button type="button"
                            class="btn btn-danger">Delete</button></a>
                    <a href="?open=Mesin-Edit&Kode=<?php echo $Kode; ?>" target="_self"><button type="button"
