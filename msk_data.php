...
$infoSql= "SELECT * FROM msk $filterSQL"; 
...
<title>Data Pembelian</title></head>
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  ...
  <tr>
    ...
    <td colspan="2" align="right"><a href="?open=Pembelian-Add" target="_self"><img src="images/btn_add_data.png" width="140" height="34" border="0"></a></td>
  </tr>
  </table>
</form>
...
<table id="dataTable" class="table-list" width="946" border="0" cellspacing="2" cellpadding="3">
  <tr>
    ...
    <td width="112" bgcolor="#CCCCCC"><strong>Supplier</strong></td>
...
$mySql 	= "SELECT a.*,convert(varchar,a.date,111) as tgl, b.name, case when a.control='1' then 'SAVED' else 'DELETED' end as stts FROM msk a inner join sub b on a.sub=b.sub $filterSQL ORDER BY a.date ASC ";
//echo $mySql;
...
?>
  <tr>
    ...
    <td> <?php echo $myData['stts']; ?>  </td>
        <td width="24" align="center"><a href="?open=Pembelian-Edit&Kode=<?php echo $Kode; ?>&Tanda=<?php echo "1"; ?>" target="_self" 
			onclick="return confirm('YAKIN INGIN MENGUBAH DATA BAGIAN INI ... ?')">Edit</a></td>
        <td width="39" align="center"><a href="?open=Pembelian-Delete&Kode=<?php echo $Kode; ?>" target="_self" 
			onclick="return confirm('YAKIN INGIN MENGHAPUS DATA BAGIAN INI ... ?')">Delete</a></td>
    <td width="41"><a href="msk_cetak.php?Kode=<?php echo $Kode; ?>" target="_blank">Cetak</a></td>
  </tr>
