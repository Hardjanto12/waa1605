...
<table id="dataTable" class="table table-striped"  width="894" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="73" bgcolor="#CCCCCC"><strong>No Produksi </strong></td>
	...
	$mySql = "select a.nojnl, convert(varchar,a.date,111) as tgl, a.remark, a.chuser, a.chtime, b.acc, b.prj, b.msn, b.inv, d.name as namainv, b.qty, b.dtseq from hsl a inner join hsd b on a.nojnl=b.nojnl inner join inv d on b.inv=d.inv WHERE a.control='1' and b.stt='1' and a.date>='$tanggal_11' and a.date<='$tanggal_22' ";
//		echo trim($txtInv);
...
$mulai	= 0; //$baris * ($hal-1); 
?>
<h2>LAPORAN HASIL PRODUKSI PER PERIODE </h2>
