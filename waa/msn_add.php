...
if(isset($_POST['btnSimpan'])){
   ...
   # Validasi Form Input 
	...
	$mySql	= "select * from msn where msn='" . trim($txtKode) . "'";
	...
	if (count($pesanError)>=1 ){
		...
		// Skrip simpan data ke database
		$mySql	= "INSERT INTO msn (msn,name, chtime, chuser) VALUES ('$txtKode','$txtNama',getdate(),'$userLogin')";
//		echo $mySql;
...
$dataNamaNas	= "";
$my2Sql	= "SELECT * FROM msn WHERE msn='$dataKode'";
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="form1" target="_self">
  <table class="table-list" width="810" border="0" cellspacing="2" cellpadding="3">
    <tr>
      <td colspan="3" bgcolor="#CCCCCC"><strong>TAMBAH DATA MESIN </strong></td>
    </tr>
    <tr>
