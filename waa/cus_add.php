...
if(isset($_POST['btnSimpan'])){
   ...
   # Validasi Form Input 
	...
	if (count($pesanError)>=1 ){
		...
		// Skrip simpan data ke database
		$mySql	= "INSERT INTO sub (sub, sub1, name, id, acc, accum, accgiro, accdisc, accppn, address, kota, area, phone, fax, hp, chtime, chuser, grup, limit) VALUES ('$txtKode','','$txtNama','', '131', '','', '','','$txtalamat','$txtKota','','$txtTelp','','$txtHP',getdate(),'$userLogin','2',0)";
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="form1" target="_self">
  <table class="table-list" width="810" border="0" cellspacing="2" cellpadding="3">
    <tr>
      <td colspan="3" bgcolor="#CCCCCC"><strong>TAMBAH DATA CUSTOMER </strong></td>
    </tr>
    <tr>
