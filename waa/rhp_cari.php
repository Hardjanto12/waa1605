...
if(isset($_GET['Kode'],$_GET['Acc'])){
	...
	$pencarianSQL	= "WHERE (sub='$Kode' and acc='$Acc') and sub='$txtKataKunci' OR acc LIKE '%$txtKataKunci%' ".$pencarianSQL;
}
...
$pageSql 	= "SELECT * FROM rhp $pencarianSQL";
...
<body>
<h1> Pencarian Register Hutang Piutang </h1>
...
<table class="table-list" width="800" border="0" cellspacing="2" cellpadding="3">
  <tr>
    ...
    <td width="140" bgcolor="#CCCCCC"><strong>Tanggal </strong></td>
    <td width="288" bgcolor="#CCCCCC"><strong>No Jurnal </strong></td>
    <td width="184" bgcolor="#CCCCCC"><strong>Remark</strong></td>
    <td width="65" bgcolor="#CCCCCC"><strong>Value</strong></td>
    <td width="48" bgcolor="#CCCCCC"><strong>Tools</strong></td>
  </tr>
  
<?php
// Skrip menampilkan data dari database
$mySql = "SELECT *, val-payment as sisa FROM rhp $pencarianSQL ORDER BY date ASC ";
...
?>
  ...
  <tr>
    ...
    <td> <?php echo $myData['sisa']; ?> </td>
    <td> 
	<a href="#" onClick="window.opener.document.getElementById('txtRef').value = '<?php echo $myData['nojnl']; ?>';
