...
# Fungsi untuk membuat kode automatis Memorial
function buatKodeMMS($tabel, $inisial, $field, $panjang, $koneksidb){
	$struktur	= sqlsrv_query($koneksidb, "SELECT $field FROM $tabel");

 	$qry	= sqlsrv_query($koneksidb, "SELECT MAX(".$field.") FROM ".$tabel);
