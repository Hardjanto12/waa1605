...
?>
  ...
  <tr>
    ...
    <td> 
	<a href="#" onClick="window.opener.document.getElementById('txtKodeNas').value = '<?php echo $myData['kdac']; ?>';
						 window.opener.document.getElementById('txtNamaNas').value = '<?php echo $myData['nmac']; ?>';
