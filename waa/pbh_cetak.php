...
if(isset($_GET['Kode'])){
	...
	$mySql = "select a.nojnl, convert(varchar,a.date,111) as tgl, a.remark, a.chuser, a.chtime, b.acc, b.prj, b.msn, b.inv, d.name as namainv, b.qty, b.dtseq from pbh a inner join pbd b on a.nojnl=b.nojnl  inner join inv d on b.inv=d.inv WHERE a.nojnl='$Kode'";
