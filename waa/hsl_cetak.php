...
if(isset($_GET['Kode'])){
	...
	$mySql = "select a.nojnl, convert(varchar,a.date,111) as tgl, a.remark, a.chuser, a.chtime, b.acc, b.prj, b.msn, b.inv, d.name as namainv, b.qty, b.dtseq from hsl a inner join hsd b on a.nojnl=b.nojnl  inner join inv d on b.inv=d.inv WHERE a.nojnl='$Kode'";
...
<table class="table-list"  width="700" border="0" cellspacing="2" cellpadding="3">
  <tr>
    <td width="155"><strong>No. Produksi </strong></td>
    <td width="10"><strong>:</strong></td>
    <td width="540"> <?php echo $myData['nojnl']; ?> </td>
  </tr>
  <tr>
    <td><strong>Tgl. Produksi </strong></td>
    <td><strong>:</strong></td>
