...
if(isset($_POST['btnCari'])) {
	...
	$pencarianSQL	= "WHERE acc='$txtKataKunci' OR name LIKE '%$txtKataKunci%' ".$pencarianSQL;
}
...
$pageSql 	= "SELECT * FROM tab $pencarianSQL";
...
$mySql = "SELECT * FROM tab $pencarianSQL ORDER BY acc ASC ";
...
?>
  ...
  <tr>
    ...
    <td> 
	<a href="#" onClick="window.opener.document.getElementById('txtTab').value = '<?php echo $myData['acc']; ?>';
...
<?php } ?>
  ...
  <tr>
	...
	for ($h = 1; $h <= $maksData; $h++) {
		...
		echo " <a href='tab_cari.php?hal=$list[$h]&keyWord=$dataKataKunci'>$h</a> ";
	}
	?>
	</td>
  </tr>
