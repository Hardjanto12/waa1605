...
if(isset($_GET['Kode'])){
	...
	// Hapus data sesuai Kode yang terbaca
 	$mySql = "update okl set control='1', chtime1=getdate(), chuser1='$userLogin' WHERE nojnl='$Kode'";
	$myQry = sqlsrv_query($koneksidb, $mySql) ;
	if( $myQry === false ) {
			 die( print_r( sqlsrv_errors(), true));
	}
 	$my2Sql = "update okl" . $prd . " set control='1', chtime1=getdate(), chuser1='$userLogin' WHERE nojnl='$Kode'";
