...
$infoSql= "SELECT * FROM hsl $filterSQL"; 
...
<title>Data Hasil Produksi</title></head>
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  ...
  <tr>
    ...
    <td colspan="2" align="right"><a href="?open=Produksi-Add" target="_self"><img src="images/btn_add_data.png" width="140" height="34" border="0"></a></td>
  </tr>
  </table>
</form>
...
$mySql 	= "SELECT a.*,convert(varchar,a.date,111) as tgl, case when a.control='1' then 'SAVED' when a.control='7' then 'WAITING' else 'DELETED' end as stts FROM hsl a  $filterSQL ORDER BY a.date ASC ";
//echo $mySql;
...
?>
  <tr>
    ...
    <td> <?php echo $myData['stts']; ?>  </td>
        <td width="24" align="center"><a href="?open=Produksi-Edit&Kode=<?php echo $Kode; ?>&Tanda=<?php echo "1"; ?>" target="_self" 
			onclick="return confirm('YAKIN INGIN MENGUBAH DATA BAGIAN INI ... ?')">Edit</a></td>
        <td width="39" align="center"><a href="?open=Produksi-Delete&Kode=<?php echo $Kode; ?>" target="_self" 
			onclick="return confirm('YAKIN INGIN MENGHAPUS DATA BAGIAN INI ... ?')">Delete</a></td>
    <td width="37"><a href="hsl_cetak.php?Kode=<?php echo $Kode; ?>" target="_blank">Cetak</a></td>
  </tr>
...
<?php } ?>
  ...
  <tr>
	...
	<?php
	for ($h = 1; $h <= $maks; $h++) {
		echo " <a href='?open=Produksi-Data&hal=$h'>$h</a> ";
	}
	?> </strong> </td>
  </tr>
</table>
