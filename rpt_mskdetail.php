...
<table id="dataTable" class="table table-striped"  width="894" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="62" bgcolor="#CCCCCC"><strong>Kode Supp </strong></td>
    <td width="64" bgcolor="#CCCCCC"><strong>Nama Supp </strong></td>
