...
if (is_null($p)){
  $_GET["p"] = 1;
echo "<meta http-equiv='refresh' content='0; url=?open=Dept-Data&p=1''>";
}

# TOMBOL CARI
if(isset($_POST['btnCari'])) {
	$txtKataKunci	= $_POST['txtKataKunci'];
	$filterSQL 		= "WHERE name LIKE '%$txtKataKunci%' OR dep like '%$txtKataKunci%'";
}
else {
	$filterSQL 	= "";
}
...
<body>
    <div class="container-fluid">
        <h1 class="display-3">Data Mesin</h1>
    </div>
    <div class="container">
        <!-- search -->
        <div class="row mt-3d-flex align-items-center">
            ...
            <div class="col-auto mb-3">
                <a href="?open=Dept-Add" target="_self">
...
?>
            <tr>
                ...
                <td width="20%">
                    <a href="?open=Dept-Delete&Kode=<?php echo $Kode; ?>" target="_self"
                        onclick="return confirm('YAKIN INGIN MENGHAPUS DATA BAGIAN INI ... ?')"><button type="button"
                            class="btn btn-danger">Delete</button></a>
                    <a href="?open=Dept-Edit&Kode=<?php echo $Kode; ?>" target="_self"><button type="button"
            ...
            <div class="col d-flex justify-content-center">
                <nav aria-label="Page navigation example">
                    ...
                    <ul class="pagination">
                        ...
                        echo '<li class="page-item '. $prevoff .'"><a class="page-link" href="?open=Mesin-Data&p='.$prev.'">Previous</a></li>';
                        ...
                        for ($x = 1; $x <= $jumlahpage; $x+=1) {
                            ...
                            echo '<li class="page-item '.$active.'"><a class="page-link" href="?open=Mesin-Data&p='.$x.'">';
                        echo "$x";
                        echo'</a></li>';
                        }
                        echo '<li class="page-item '. $nxtoff .'"><a class="page-link" href="?open=Mesin-Data&p='. $nxt .'">Next</a></li>';?>
                    </ul>
                </nav>
                <!-- end pagination -->
            </div>
