...
<table class="table-list" width="800" border="0" cellspacing="2" cellpadding="3">
  <tr>
    ...
    <td width="65" bgcolor="#CCCCCC"><strong>Stock </strong></td>
...
$mySql = "SELECT a.*, b.stock FROM inv a left outer join rin b on a.inv=b.inv $pencarianSQL ORDER BY inv ASC ";
...
?>
  ...
  <tr>
    ...
    <td align="right"> <?php echo format_angka($myData['stock']); ?> </td>
