...
if (is_null($p)){
  $_GET["p"] = 1;
echo "<meta http-equiv='refresh' content='0; url=inv_cari2.php?p=1'>";
}
...
$stmt = sqlsrv_query( $koneksidb, "SELECT * FROM inv" , $params, $options );
...
$datapageinv = "WITH
            ...
            (
                SELECT ROW_NUMBER() OVER (
                          ORDER BY 
                                  a.inv ASC
                          ) row_num, a.*, b.stock FROM inv a left outer join rin b on a.inv=b.inv $pencarianSQL
            )
        SELECT
            *
        FROM
...
<body>
    <div class="container-fluid">
        <h1 class="display-5">PENCARIAN INVENTORY</h1>
    </div>
    <div class="container-fluid">
        <!-- search box -->
        <div class="row">
...
$myQry = sqlsrv_query($koneksidb, $datapageinv);
...
?>
            ...
            <tr>
                ...
                <td> <?php echo format_angka($myData['stock']); ?> </td>
            ...
            <tr>
                ...
                <td colspan="3" align="right">
                    <div class="col d-flex justify-content-center">
                        ...
                        echo '<li class="page-item '. $prevoff .'"><a class="page-link" href="inv_cari2.php?p='.$prev.'">Previous</a></li>';
                        ...
                        for ($x = 1; $x <= $jumlahpage; $x+=1) {
                            ...
                            echo '<li class="page-item '.$active.'"><a class="page-link" href="inv_cari2.php?p='.$x.'">';
                        echo "$x";
                        echo'</a></li>';
                        }
                        echo '<li class="page-item '. $nxtoff .'"><a class="page-link" href="inv_cari2.php?p='. $nxt .'">Next</a></li>';?>
                            </ul>
                        </nav>
                        <!-- end pagination -->
                    </div>
