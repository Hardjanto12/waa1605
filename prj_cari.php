...
if (is_null($p)){
  $_GET["p"] = 1;
echo "<meta http-equiv='refresh' content='0; url=prj_cari.php?p=1'>";
}
...
$stmt = sqlsrv_query( $koneksidb, "SELECT * FROM prj" , $params, $options );
...
<body>
    <div class="container-fluid">
        <h1 class="display-5">PENCARIAN PROYEK</h1>
    </div>
    <div class="container-fluid">
        <!-- search box -->
        <div class="row">
...
$myQry = sqlsrv_query($koneksidb, $datapageprj);
// $nomor  = 0; 
            ...
            <tr>
                ...
                <td>
                    <a href="#" onClick="window.opener.document.getElementById('txtPrj').value = '<?php echo $myData['prj']; ?>';
						 window.opener.document.getElementById('txtNamaPrj').value = '<?php echo $myData['name']; ?>';
            ...
            <tr>
                ...
                <td colspan="3" align="right">
                    <div class="col d-flex justify-content-center">
                        ...
                        echo '<li class="page-item '. $prevoff .'"><a class="page-link" href="prj_cari.php?p='.$prev.'">Previous</a></li>';
                        ...
                        for ($x = 1; $x <= $jumlahpage; $x+=1) {
                            ...
                            echo '<li class="page-item '.$active.'"><a class="page-link" href="prj_cari.php?p='.$x.'">';
                        echo "$x";
                        echo'</a></li>';
                        }
                        echo '<li class="page-item '. $nxtoff .'"><a class="page-link" href="prj_cari.php?p='. $nxt .'">Next</a></li>';?>
                            </ul>
                        </nav>
                        <!-- end pagination -->
                    </div>
